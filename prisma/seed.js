// Arquivo para semear/popular banco de dados com conteúdos mockados, ou seja, inseridos diretamente pelo desenvolvedor ao invés dos usuários reais da aplicação
// Prisma seed - dados para serem inseridos no banco: $ npx prisma db seed
...
async function main() {
  ...
  // Função 'upsert()': Atualizar ou inserir o dado/objeto
